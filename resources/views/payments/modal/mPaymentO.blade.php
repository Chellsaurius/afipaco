<div class="modal fade" id="pagarModalotros{{ $local->local_id }}" data-bs-backdrop="static" data-bs-keyboard="false"
                ...
                <form id="formulario">
                    ...
                    <div class="d-flex justify-content-between row ">
                        ...
                        <div class="mb-3 col-6 border">
                            ...
                            <input type="text" name="days" class="form-control" value="{{ $local->local_daysText }}" 
                                id="days" aria-describedby="daysHelp" readonly hidden>
                            <input type="text" class="form-control" value="{{ trim($local->$local->local_daysText, ',') }}"
                                readonly>
                        ...
                        <div class="mb-3 col-3 border">
                            ...
                            <input type="text" name="measurment" class="form-control" id="measurements"
