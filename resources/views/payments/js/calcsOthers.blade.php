...
<script>
    function daysDifference(id) {
        ...
        // console.log('FUERA DEL DOWHILE start ES: ' + start)
        // console.log('FUERA DEL DOWHILE end ES: ' + end)
        /*if (start == dt && end >= dt) {
        //if (loop.toDateString() == dt.toDateString()) {
            console.log("/////////// ENTRÓ A LA COMPARACIÓN ***************: con el valor" + loop.toDateString() + dt.toDateString())
            for (let index = 0; index <= cadena.length; index++) {
                console.log('el index de fuera es: ' + index)
...
<script>
    function show_my_receiptOthers(id) {
        console.log(id)
        var id = id;
