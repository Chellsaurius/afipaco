...
@section('content')
                ...
                <div class="card">
                    <div class="card-header">Nuevo pago del comerciante con CURP: {{ Str::upper($merchant->merchant_curp) }} </div>
                        <form id="formulario" class="pt-2 px-3">
                            ...
                            <input type="hidden" name="localVenue" id="localVenue{{ $local->local_id }}" value="Vía pública">
                            ...
                            <div class="d-flex justify-content-start row ">
                                ...
                                <div class="mb-3 col-6 border">
                                    ...
                                    @endif </label>
                                    <input type="hidden" id="area{{ $local->local_id }}" value="{{ number_format($local->local_area, 2) }}" readonly >
                        ...
                        <div class="mb-3 col-6 ps-3">
                            ...
                            <button class="btn btn-primary col-5" id="btn{{ $local->local_id }}" onclick="show_my_receiptOthers({{ $local->local_id }})">Generar pago </button> 
                        </div>
                    </div>
                </div>
            </div>
    ...
    @include('payments.js.calcsOthers')
@endsection