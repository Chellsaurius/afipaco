...
@section('content')    
    <div class="contents">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">Lista de comerciantes</div>

                    <div class="card-body">
                        <table id="merchants" class="table table-striped dt-responsive nowrap table-bordered" style="width:100%">
                            <thead>
                                <tr>
                                    <th>Nombres</th>
                                    <th>Domicilio</th>
                                    ...
                                    <tr @if ($merchant->merchant_status == 2)
                                        ...
                                        <td>
                                            @if ($merchant->merchant_status == 2)
                                                <a class="btn btn-warning" href="{{ route('warnings.especificList', $merchant->merchant_curp) }}"> <i class="fa-solid fa-circle-exclamation"></i> Ver apercibimientos </a>
